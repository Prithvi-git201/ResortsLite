...
public class BookingController {
    ...
    // This enables distributed caching across multiple instances with proper TTL
    @Autowired
    ...
    public Map<String, Object> createBooking(
        ...
        // FIXED cr-java-0067: Store booking in Redis with TTL instead of unbounded in-memory cache
        String bookingKey = "booking:" + booking.get("bookingId");
        redisTemplate.opsForValue().set(bookingKey, booking, 24, TimeUnit.HOURS);
    ...
    public Map<String, Object> checkAvailability(@RequestParam String roomType) {
        ...
        // URL is now injected via @Value annotation from environment-specific configuration
