...
public class BookingService {
    ...
    // cz-java-0062 FIX: Replaced hardcoded IP address (10.0.1.45) with an environment variable
    // injected via AWS Service Connect on ECS Fargate. Containers discover each other by logical
    // service name; the PAYMENT_SERVICE_URL environment variable is set in the ECS task definition
    // to the Service Connect endpoint (e.g. http://payment-service:9090/payments/charge).
    // This removes the hardcoded internal IP that breaks on container restart or redeployment.
