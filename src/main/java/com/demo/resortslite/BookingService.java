...
public class BookingService {
    ...
    // cz-java-0062: Replaced hardcoded IP address (10.0.1.45) with an environment variable
    // injected via Kubernetes ConfigMap / Azure Key Vault CSI Driver on AKS.
    // Set PAYMENT_API_URL in your pod spec or ConfigMap to the actual payment service endpoint.
    @Value("${PAYMENT_API_URL:http://payment-svc.internal:9090/payments/charge}")
